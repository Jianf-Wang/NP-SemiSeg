...
class dec_deeplabv3_plus(nn.Module):
    def __init__(
        ...
        self.classifier1 = NP_HEAD(input_dim=256+int(low_conv_planes), num_classes=num_classes)
    ...
    def forward(self, x, deterministic_memory, latent_memory, x_context_in=None, labels_target_in=None, labels_context_in=None, forward_times=5, phase_train=True):
        ...
        if phase_train:
           ...
           return output, mean, sigma, mean_c, sigma_c, deterministic_memory, latent_memory
        else:
